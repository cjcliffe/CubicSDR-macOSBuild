...
all_modules: SoapyRTLSDR SoapyAudio SoapyRemote SoapyAirspy SoapyAirspyHF SoapyHackRF SoapyRedPitaya SoapyBladeRF LimeSuite SoapySDRPlay
...
SoapyRemote: SoapySDR install_dir/lib/SoapySDR/modules${SOAPY_ABI_VERSION}/libremoteSupport.so
install_dir/lib/SoapySDR/modules${SOAPY_ABI_VERSION}/libremoteSupport.so:
	...
	cmake -S build_stage/SoapyRemote -B build_stage/SoapyRemote/build -DCMAKE_BUILD_TYPE=Release -DCMAKE_INSTALL_PREFIX=${INSTALL_DIR} -DCMAKE_PREFIX_PATH=${INSTALL_DIR}
	cd build_stage/SoapyRemote/build && make -j${NPROC} && make install
	ls -la install_dir/lib/SoapySDR/modules${SOAPY_ABI_VERSION}/libremoteSupport.so


SoapyAirspy: SoapySDR install_dir/lib/SoapySDR/modules${SOAPY_ABI_VERSION}/libairspySupport.so
install_dir/lib/SoapySDR/modules${SOAPY_ABI_VERSION}/libairspySupport.so:
	...
	cmake -S build_stage/SoapyAirspy -B build_stage/SoapyAirspy/build -DCMAKE_BUILD_TYPE=Release -DCMAKE_INSTALL_PREFIX=${INSTALL_DIR} -DCMAKE_PREFIX_PATH=${INSTALL_DIR}
	cd build_stage/SoapyAirspy/build && make -j${NPROC} && make install


SoapyAirspyHF: SoapySDR install_dir/lib/SoapySDR/modules${SOAPY_ABI_VERSION}/libairspyhfSupport.so
install_dir/lib/SoapySDR/modules${SOAPY_ABI_VERSION}/libairspyhfSupport.so:
	...
	cmake -S build_stage/SoapyAirspyHF -B build_stage/SoapyAirspyHF/build -DCMAKE_BUILD_TYPE=Release -DCMAKE_INSTALL_PREFIX=${INSTALL_DIR} -DCMAKE_PREFIX_PATH=${INSTALL_DIR}
	cd build_stage/SoapyAirspyHF/build && make -j${NPROC} && make install


SoapyHackRF: SoapySDR install_dir/lib/SoapySDR/modules${SOAPY_ABI_VERSION}/libHackRFSupport.so
install_dir/lib/SoapySDR/modules${SOAPY_ABI_VERSION}/libHackRFSupport.so:
	...
	cmake -S build_stage/SoapyHackRF -B build_stage/SoapyHackRF/build -DCMAKE_BUILD_TYPE=Release -DCMAKE_INSTALL_PREFIX=${INSTALL_DIR} -DCMAKE_PREFIX_PATH=${INSTALL_DIR}
	cd build_stage/SoapyHackRF/build && make -j${NPROC} && make install



SoapyRedPitaya: SoapySDR install_dir/lib/SoapySDR/modules${SOAPY_ABI_VERSION}/libRedPitaya.so
install_dir/lib/SoapySDR/modules${SOAPY_ABI_VERSION}/libRedPitaya.so:
	...
	cmake -S build_stage/SoapyRedPitaya -B build_stage/SoapyRedPitaya/build -DCMAKE_BUILD_TYPE=Release -DCMAKE_INSTALL_PREFIX=${INSTALL_DIR} -DCMAKE_PREFIX_PATH=${INSTALL_DIR}
	cd build_stage/SoapyRedPitaya/build && make -j${NPROC} && make install


SoapyBladeRF: SoapySDR install_dir/lib/SoapySDR/modules${SOAPY_ABI_VERSION}/libbladeRFSupport.so
install_dir/lib/SoapySDR/modules${SOAPY_ABI_VERSION}/libbladeRFSupport.so:
	...
	cmake -S build_stage/SoapyBladeRF -B build_stage/SoapyBladeRF/build -DCMAKE_BUILD_TYPE=Release -DCMAKE_INSTALL_PREFIX=${INSTALL_DIR} -DCMAKE_PREFIX_PATH=${INSTALL_DIR}
	cd build_stage/SoapyBladeRF/build && make -j${NPROC} && make install


LimeSuite: SoapySDR install_dir/lib/SoapySDR/modules${SOAPY_ABI_VERSION}/libLMS7Support.so
install_dir/lib/SoapySDR/modules${SOAPY_ABI_VERSION}/libLMS7Support.so:
	scripts/update_repo.sh build_stage/LimeSuite https://github.com/myriadrf/LimeSuite.git
	mkdir -p build_stage/LimeSuite/build || true
	cmake -S build_stage/LimeSuite -B build_stage/LimeSuite/build -DCMAKE_BUILD_TYPE=Release -DCMAKE_INSTALL_PREFIX=${INSTALL_DIR} -DCMAKE_PREFIX_PATH=${INSTALL_DIR}
	cd build_stage/LimeSuite/build && make -j${NPROC} && make install


SoapySDRPlay: SoapySDR install_dir/lib/SoapySDR/modules${SOAPY_ABI_VERSION}/libsdrplaySupport.so
install_dir/lib/SoapySDR/modules${SOAPY_ABI_VERSION}/libsdrplaySupport.so:
	...
	cmake -S build_stage/SoapySDRPlay -B build_stage/SoapySDRPlay/build -DCMAKE_BUILD_TYPE=Release -DCMAKE_INSTALL_PREFIX=${INSTALL_DIR} -DCMAKE_PREFIX_PATH=${INSTALL_DIR}
	cd build_stage/SoapySDRPlay/build && make -j${NPROC} && make install
